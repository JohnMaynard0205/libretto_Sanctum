...
@section('title', 'Edit Review - Libretto')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-edit"></i> Edit Review for "{{ $review->book->title }}"
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('reviews.update', $review) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('content') is-invalid @enderror" 
                                  ...
                                  rows="5" 
                                  required 
                                  placeholder="Write your review here...">{{ old('content', $review->content) }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('reviews.show', $review) }}" class="btn btn-info me-2">
